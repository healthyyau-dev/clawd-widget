'use strict'
// Post-build step: the root `Clawd Setup.exe` is the single source of truth for the installer.
...
console.log('publish-installer: updated root "' + NAME + '" (' + kb + ' KB)')
